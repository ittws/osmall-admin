<template>
    <div>
        ...
        <Button type="success" v-if="!row.active" size="small" @click="enable(row)">发放</Button>
        <Button type="error" v-if="row.active" size="small" @click="disable(row)">暂停</Button>   
        <Dropdown trigger="hover" transfer @on-click='moreaction'>
            ...
            <DropdownMenu slot="list">
                <!-- <DropdownItem name='data'>数据</DropdownItem> -->
                <!-- <DropdownItem name='link'>链接</DropdownItem> -->
