...
<template>
  <div>
          ...
          <Row>
            <RadioGroup v-model="dateSearchType" @on-change="changeSearchDate">
              ...
              <Input
                ...
                style="width: 120px"
              />
              <Select v-model="searchMerchant" placeholder="选择团长" style="width:120px"  filterable remote :remote-method="inquiryMerchant" :loading="merchantLoading" clearable>
                <Option
              ...
              <Input v-model="searchName" placeholder="会员姓名" style="width: 120px" />
    ...
    <Modal title="物流信息" v-model="courierModal" :closable="false" :mask-closable="false">
      <Form :label-width="90">
        <FormItem label="物流公司">
...
export default {
            ...
            return h("div", [
              ...
              h(
                "Button",
                {
                  ...
                  style: {
                    margin: "0 5px 0 0",
                    display: params.row.orderStatus === "1" ? "display" : "none"
                  },
                  on: {
                    click: () => {
              ...
              h(
                "Button",
                {
                  ...
                  style: {
                    margin: "0 5px 0 0",
                    display: params.row.orderStatus === "2" ? "display" : "none"
                  },
                  on: {
                    click: () => {
                      this.courierOrder(params.row);
  ...
  methods: {
    ...
    completeOrder(e) {
      ...
      this.$http
        .post("/admin/completeOrder", this.common.request(logistics))
        .then(
          response => {
            this.loading = false;
            if (response.data.body.status.statusCode == 0) {
    ...
    searchOrder(startIndex, pageSize, isExport) {
      ...
      let keyArray = ['ORDERTYPE'];
      searchOptions.orderType = '3';
      //选择日期
